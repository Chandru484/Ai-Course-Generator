        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our AI-powered platform makes course creation simple, fast, and engaging
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 card-hover">
              ...
              <p className="text-gray-600">
                Generate comprehensive course content, outlines, and materials using advanced AI technology.
              </p>
            </div>

            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-8 card-hover">
              <div className="bg-purple-600 w-12 h-12 rounded-lg flex items-center justify-center mb-6">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Multimedia Integration</h3>
              <p className="text-gray-600">
                Automatically integrate videos, images, and interactive content from YouTube and other sources.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8 card-hover">
              ...
              <p className="text-gray-600">
                Organize and manage your courses with our intuitive dashboard and course management tools.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join thousands of educators who are already using our platform to create amazing learning experiences.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Create amazing courses with AI assistance. Build professional educational experiences in minutes.
              </p>
            </div>
            <div>
